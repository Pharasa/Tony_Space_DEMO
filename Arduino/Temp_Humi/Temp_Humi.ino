...
const char* mqttServer = "vsmqtt.space";
...
void loop()
{
   ...
   if (!isnan(t)){
      ...
      String toPublish = String(t);
      mqtt.publish("temp", toPublish.c_str());
    ...
    if(!isnan(h)){
      ...
      String toPublish = String(h);
      mqtt.publish("humi", toPublish.c_str());
